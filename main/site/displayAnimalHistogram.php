<?php
    ...
    $url="http://localhost/WebApplications/site/getAnimalWithTime.php";
...
<body>
    ...
    <script>
        ...
        var values = <?php echo json_encode($array); ?>;
        console.log(values);
        var info = "Total: ";
        var sentence = "This shows classified photos of this animal against time of day";
