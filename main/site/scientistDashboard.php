		...
		<div class="row">
			...
			<!-- form-middle-col -->
				...
				<?php		
			        ...
			        echo '<form id="inputs" role="form" action="displayAnimalHistogram.php" method="get">';
					echo '  <select name="species[]" class="form-control" id="speciesSelectTime" form="inputs" size=6>';
